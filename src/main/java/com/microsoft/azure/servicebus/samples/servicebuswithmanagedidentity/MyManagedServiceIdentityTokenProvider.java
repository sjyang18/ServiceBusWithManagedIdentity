...
import com.microsoft.azure.servicebus.security.*;
 ...
 *
 */
public class MyManagedServiceIdentityTokenProvider extends TokenProvider
{
    private static final Logger TRACE_LOGGER = LoggerFactory.getLogger(MyManagedServiceIdentityTokenProvider.class);
    ...
    private static MSIToken getMSIToken(String audience) throws IOException
    {
        ...
        if(useStaticHttpUrl)
        {
            ...
            String localMSIURLForResouce = String.format(DYNAMIC_MSI_URL_FORMAT, STATIC_LOCAL_REST_MSI_ENDPOINT_URL, audience, APIVERSION);
            TRACE_LOGGER.info("localMSIURLForResouce: " + localMSIURLForResouce);
        ...
        TRACE_LOGGER.info("MSI access token retrieved: " + msiToken.getAccessToken());
        return msiToken;
    }
